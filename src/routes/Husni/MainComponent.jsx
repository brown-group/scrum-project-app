...
export default function MainComponent() {
  ...
  const handleDarkModeToggle = () => {
    ...
    if (!isDarkMode) {
      wrapper.classList.add("husni-active");
    } else {
      wrapper.classList.remove("husni-active");
    }
  };
    ...
    <div id="wrapper">
      <div className="husni">
        ...
        <div className="husni-header">
          <a href="#home" className="husni-logo">
            Your <span>Name</span>.
          </a>
        ...
        <section className="husni-home" id="home">
          ...
          <div className="husni-home-text">
            ...
            <p>
              ...
              fermentum est nisl, id viverra ex consectetur sed. Vivamus
              condimentum mauris in urna tempor aliquam. Quisque fermentum est
              nisl, id viverra ex consectetur sed. Vivamus condimentum mauris in
              urna tempor aliquam. Vestibulum vitae bibendum ante, quis eleifend
              elit, lacinia tincidunt erat.
            </p>
            <a
          ...
          <div className="husni-about-container">
            ...
            <div className="husni-about-text">
              <p>
                ...
                fermentum est nisl, id viverra ex consectetur sed. Vivamus
                condimentum mauris in urna tempor aliquam. Vestibulum vitae
                bibendum ante, quis eleifend elit.
              </p>
              <div className="husni-information">
                <div className="husni-info-box">
                  <i className="bx bx-laptop"></i> <span>Your Name.</span>
                </div>
                <div className="husni-info-box">
                  <i className="bx bxs-phone"></i> <span>+123456789</span>
                </div>
                <div className="husni-info-box">
                  <i className="bx bxs-envelope"></i>{" "}
                  <span>
                    <a href="mailto:husnihhamdan@gmail.com">
